...
/**
 * redirfs_create_attribute() - creates a sysfs attribute for filter
...
/**
 * redirfs_remove_attribute() - remove a sysfs attribute from filter
 * @filter:	pointer to the filter
 * @attr:	attribute description
 **/
...
/**
 * redirfs_filter_kobject() - retrieves the kobject asssociated with filter
 * @filter:	pointer to the filter
 **/
